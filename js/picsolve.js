	...
	let dialog = new Image(),sword = new Image(),shield = new Image(),win = new Image()
	...
	dialog.src= "img/dialog/dialog.png";
	sword.src= "img/dialog/sword.png";
	shield.src= "img/dialog/shield.png";
	win.src= "img/dialog/win.png";
